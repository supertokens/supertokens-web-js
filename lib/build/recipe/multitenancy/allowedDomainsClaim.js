...
var AllowedDomainsClaimClass = /** @class */ (function (_super) {
    ...
    function AllowedDomainsClaimClass() {
        ...
        _this.validators = __assign(__assign({}, _this.validators), { hasAccessToCurrentDomain: function () { return ({
                id: _this.id,
                ...
                validate: function (payload, userContext) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        includesValidator = this.validators.includes(currentDomain, Number.MAX_SAFE_INTEGER, this.id);
