...
exports.executePreAPIHooks = exports.normaliseUserInput = void 0;
function normaliseUserInput(config) {
    ...
    if (postAPIHook === undefined) {
        postAPIHook = function (_a) {
            var fetchResponse = _a.fetchResponse;
            return __awaiter(_this, void 0, void 0, function () {
...
function executePreAPIHooks(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    return [4 /*yield*/, config.preAPIHook(__assign(__assign({}, context), { action: action }))];
                case 1:
...
exports.executePreAPIHooks = executePreAPIHooks;
