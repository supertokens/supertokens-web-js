...
var Recipe = /** @class */ (function (_super) {
    ...
    Recipe.init = function (config) {
        return function (appInfo, clientType, _enableDebugLogs, overrideMaps) {
            Recipe.instance = new Recipe(__assign(__assign({}, (0, utils_1.applyPlugins)(Recipe.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : [])), { recipeId: Recipe.RECIPE_ID, appInfo: appInfo, clientType: clientType }));
            return Recipe.instance;
        };
    };
    Recipe.getInstanceOrThrow = function () {
        if (Recipe.instance === undefined) {
            var error = "No instance of Passwordless found. Ensure that the 'Passwordless.init' method is called within the 'SuperTokens.init' recipeList.";
