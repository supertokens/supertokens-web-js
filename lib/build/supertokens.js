...
var utils_1 = require("./common/storage/utils");
...
var SuperTokens = /** @class */ (function () {
    function SuperTokens(config) {
        var _this = this;
        this.recipeList = [];
        this.appInfo = (0, utils_2.normaliseInputAppInfoOrThrowError)(config.appInfo);
        this.storageHandlers = (0, utils_1.normaliseStorageHandlerInput)(config.storageHandlers);
        ...
        this.recipeList = config.recipeList.map(function (recipe) {
            return recipe(_this.appInfo, _this.storageHandlers);
        });
    }
    /**
