...
function getRecipeImplementation(recipeImplInput) {
    ...
    return {
        ...
        getLinkCodeFromURL: function () {
            return windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.location.getHash();
        },
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                recipeImplInput.storageHandlers.localStorage.getItem(
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                recipeImplInput.storageHandlers.localStorage.setItem(
                                    constants_1.PASSWORDLESS_LOGIN_ATTEMPT_INFO_STORAGE_KEY,
                                    JSON.stringify(
                                        __assign(
                                            {
        ...
        clearLoginAttemptInfo: function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    recipeImplInput.storageHandlers.localStorage.removeItem(
                        constants_1.PASSWORDLESS_LOGIN_ATTEMPT_INFO_STORAGE_KEY
                    );
                    return [2 /*return*/];
                });
