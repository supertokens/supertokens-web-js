    ...
    return {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, querier.post(tenantId, "/user/email/verify", {
                                    body: JSON.stringify({
                                        method: "token",
                                        token: token,
                                    }),
        ...
        isEmailVerified: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, querier.get(undefined, "/user/email/verify", {}, undefined, querier_1.default.preparePreAPIHook({
                                recipePreAPIHook: recipeImpleInput.preAPIHook,
        ...
        sendVerificationEmail: function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, querier.post(undefined, "/user/email/verify/token", { body: JSON.stringify({}) }, querier_1.default.preparePreAPIHook({
                                recipePreAPIHook: recipeImpleInput.preAPIHook,
