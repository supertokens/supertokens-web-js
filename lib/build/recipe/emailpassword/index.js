...
var RecipeWrapper = /** @class */ (function () {
    ...
    RecipeWrapper.verifyEmail = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            var emailVerificationRecipeImpl;
            return __generator(this, function (_a) {
                emailVerificationRecipeImpl =
                    recipe_1.default.getInstanceOrThrow().emailVerificationRecipe.recipeImplementation;
                return [
                    2 /*return*/,
                    emailVerificationRecipeImpl.verifyEmail(
    ...
    RecipeWrapper.isEmailVerified = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [
                    2 /*return*/,
                    emailVerificationRecipeImpl.isEmailVerified(
                        __assign(__assign({}, input), {
                            userContext: (0, utils_1.getNormalisedUserContext)(
                                input === null || input === void 0 ? void 0 : input.userContext
                            ),
