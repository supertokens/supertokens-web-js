...
var recipe_2 = require("../multitenancy/recipe");
...
var RecipeWrapper = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [
                            2 /*return*/,
                            recipe.recipeImplementation.getThirdPartyAuthorisationURLWithQueryParamsAndSetState(
    ...
    RecipeWrapper.getTenantIdFromURL = function (input) {
        return recipe_1.default
            .getInstanceOrThrow()
            .recipeImplementation.getTenantIdFromURL(
                __assign(__assign({}, input), {
                    userContext: (0, utils_1.getNormalisedUserContext)(
                        input === null || input === void 0 ? void 0 : input.userContext
                    ),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [
                            2 /*return*/,
                            recipe.recipeImplementation.setPasswordlessLoginAttemptInfo({
