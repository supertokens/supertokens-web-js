                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, querier.get(input.tenantId, "/authorisationurl", {}, queryParams, querier_1.default.preparePreAPIHook({
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, querier.post(verifiedState.tenantId, "/signinup", {
                                    body: JSON.stringify({
