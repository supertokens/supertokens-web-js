            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/oauth/login/info",
                                {},
                                queryParams,
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            _d = (_c = querier).get;
                            return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().recipeImplementation.getTenantId({ userContext: userContext })];
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/oauth/login",
                                {},
                                {
                                    loginChallenge: loginChallenge,
                                },
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            _d = (_c = querier).post;
                            return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().recipeImplementation.getTenantId({ userContext: userContext })];
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/oauth/logout",
                                {
