    ...
    function Querier(recipeId, appInfo) {
        ...
        this.get = function (tenantId, path, config, queryParams, preAPIHook, postAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result, _b, jsonBody;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _b = this.fetch;
                            return [4 /*yield*/, this.getFullUrl(tenantId, path, queryParams)];
                        case 1:
                            return [
                                4 /*yield*/,
                                _b.apply(this, [
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            _b = this.fetch;
                            return [4 /*yield*/, this.getFullUrl(tenantId, path)];
                        case 1:
                            return [
                                4 /*yield*/,
                                _b.apply(this, [
        ...
        this.getFullUrl = function (tenantId, pathStr, queryParams) {
            return __awaiter(_this, void 0, void 0, function () {
                var basePath, path, fullUrl;
                return __generator(this, function (_b) {
                    basePath = this.appInfo.apiBasePath.getAsStringDangerous();
                    if (tenantId !== undefined && tenantId !== "public") {
                        basePath = "".concat(basePath, "/").concat(tenantId);
                    }
                    path = new normalisedURLPath_1.default(pathStr);
                    fullUrl = ""
                        .concat(this.appInfo.apiDomain.getAsStringDangerous())
                        .concat(basePath)
                    ...
                    // If query params, add.
                    return [2 /*return*/, fullUrl + "?" + new URLSearchParams(queryParams)];
                });
            });
        };
