...
var MultiFactorAuthClaimClass = /** @class */ (function () {
    function MultiFactorAuthClaimClass(getRecipeImpl) {
        ...
        this.id = "st-mfa";
        this.validators = {
            hasCompletedDefaultFactors: function () {
                return {
                    id: _this.id,
                                ...
                                return [
                                    2 /*return*/,
                                    {
                                        ...
                                        reason: {
                                            ...
                                            nextFactorOptions: val === null || val === void 0 ? void 0 : val.n,
                                        },
                                    },
                                ];
                            });
            ...
            hasCompletedFactors: function (requirements) {
                return {
                    ...
                    validate: function (payload, userContext) {
                        ...
                        var recipeImpl = _this.getRecipeImpl();
                        for (var _i = 0, requirements_1 = requirements; _i < requirements_1.length; _i++) {
                            ...
                            if (typeof req === "object" && "oneOf" in req) {
                                var res = req.oneOf
                                    .map(function (r) {
                                        return recipeImpl.checkFactorRequirement({
                                ...
                                var res = recipeImpl.checkFactorRequirement({
                                    completedFactors: completedFactors,
                                    req: req,
                                    payload: payload,
                                    userContext: userContext,
    ...
    MultiFactorAuthClaimClass.prototype.refresh = function (userContext) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        return [4 /*yield*/, this.getRecipeImpl().getMFAInfo(userContext)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
