...
var RecipeWrapper = /** @class */ (function () {
    ...
    RecipeWrapper.getStateAndOtherInfoFromStorage = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.getStateAndOtherInfoFromStorage(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        tenantId = _a.sent();
                        return [2 /*return*/, recipe.recipeImplementation.getAuthorisationURLWithQueryParamsAndSetState(__assign(__assign({ tenantId: tenantId }, input), { shouldTryLinkingWithSessionUser: input === null || input === void 0 ? void 0 : input.shouldTryLinkingWithSessionUser, userContext: userContext }))];
                }
            });
        });
    };
    ...
    RecipeWrapper.signInAndUp = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.signInAndUp(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
