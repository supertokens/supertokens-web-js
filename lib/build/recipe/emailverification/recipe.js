...
var Recipe = /** @class */ (function () {
    function Recipe(config) {
        ...
        postSuperTokensInitCallbacks_1.PostSuperTokensInitCallbacks.addPostInitCallback(function () {
            sessionClaimValidatorStore_1.SessionClaimValidatorStore.addClaimValidatorFromOtherRecipe(Recipe.EmailVerificationClaim.validators.isVerified(10));
        });
    }
    Recipe.init = function (config) {
        return function (appInfo, clientType, _enableDebugLogs, overrideMaps) {
            Recipe.instance = new Recipe(__assign(__assign({}, (0, utils_2.applyPlugins)(Recipe.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : [])), { appInfo: appInfo, clientType: clientType, recipeId: Recipe.RECIPE_ID }));
    ...
    Recipe.EmailVerificationClaim = new emailVerificationClaim_1.EmailVerificationClaimClass(function () { return Recipe.getInstanceOrThrow().recipeImplementation; });
    return Recipe;
}());
