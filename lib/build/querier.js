...
var Querier = /** @class */ (function () {
    function Querier(recipeId, appInfo) {
        var _this = this;
        this.get = function (path, config, userContext, queryParams, preAPIHook, postAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result, fetchResponse, jsonBody;
        ...
        this.post = function (path, config, userContext, preAPIHook, postAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result, fetchResponse, jsonBody;
                return __generator(this, function (_b) {
                    switch (_b.label) {
        ...
        this.delete = function (path, config, userContext, preAPIHook, postAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result, fetchResponse, jsonBody;
                return __generator(this, function (_b) {
                    switch (_b.label) {
        ...
        this.put = function (path, config, userContext, preAPIHook, postAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                var result, fetchResponse, jsonBody;
                return __generator(this, function (_b) {
                    switch (_b.label) {
        ...
        this.fetch = function (url, config, userContext, preAPIHook, postAPIHook) {
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(_a, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                config.postAPIHook(__assign(__assign({}, context), { action: action })),
                            ];
                        case 1:
                            _b.sent();
                            return [2 /*return*/];
