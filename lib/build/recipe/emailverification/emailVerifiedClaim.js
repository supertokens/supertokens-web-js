...
exports.EmailVerifiedClaimClass = void 0;
var session_1 = require("../session");
var EmailVerifiedClaimClass = /** @class */ (function (_super) {
    __extends(EmailVerifiedClaimClass, _super);
    function EmailVerifiedClaimClass(getRecipeImpl) {
        var _this =
            _super.call(this, {
                id: "st-ev",
        ...
        _this.validators = __assign(__assign({}, _this.validators), {
            isValidated: function (minRefetchDelayInSeconds, getRedirectPath) {
                if (minRefetchDelayInSeconds === void 0) {
                    minRefetchDelayInSeconds = 10;
                }
                return {
                    id: _this.id,
                    ...
                    validate: function (payload, userContext) {
                        return __awaiter(_this, void 0, void 0, function () {
                            var value, redirectPath, _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        value = this.getValueFromPayload(payload, userContext);
                                        if (!(getRedirectPath !== undefined && value !== true)) return [3 /*break*/, 2];
                                        return [4 /*yield*/, getRedirectPath()];
                                    case 1:
                                        _a = _b.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
    ...
    return EmailVerifiedClaimClass;
