    ...
    return {
        ...
        getThirdPartyLoginRedirectURL: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var provider, state, urlResponse, urlObj, alreadyContainsRedirectURI, urlWithState;
        ...
        signInAndUp: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var provider, stateFromStorage, code, stateFromQueryParams, redirectURI, _a, jsonBody, fetchResponse;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            provider = input.config.signInAndUpFeature.providers.find(function (p) {
                            ...
                            return [4 /*yield*/, provider.getRedirectURL(input.config.appInfo)];
                        case 1:
                            redirectURI = _b.sent();
                            return [
                                4 /*yield*/,
