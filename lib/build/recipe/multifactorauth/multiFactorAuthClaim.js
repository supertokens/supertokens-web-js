...
var MultiFactorAuthClaimClass = /** @class */ (function () {
    function MultiFactorAuthClaimClass(getRecipeImpl) {
        ...
        this.id = "st-mfa";
        this.validators = {
            hasCompletedMFARequirementsForAuth: function () { return ({
                id: _this.id,
                refresh: function () {
                    var args = [];
                ...
                validate: function (payload, userContext) { return __awaiter(_this, void 0, void 0, function () {
                    var val;
            ...
            hasCompletedFactors: function (requirements) { return ({
                id: _this.id,
                shouldRefresh: function (payload, userContext) {
                    var val = _this.getValueFromPayload(payload, userContext);
                    return val === undefined;
                ...
                validate: function (payload, userContext) {
                    ...
                    for (var _i = 0, requirements_1 = requirements; _i < requirements_1.length; _i++) {
                        ...
                        if (typeof req === "object" && "oneOf" in req) {
                            var res = req.oneOf
                                .map(function (r) { return (0, utils_1.checkFactorRequirement)(r, completedFactors); })
                                .filter(function (v) { return v.isValid === false; });
    ...
    MultiFactorAuthClaimClass.prototype.refresh = function (userContext) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRecipeImpl().resyncSessionAndFetchMFAInfo(userContext)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
