...
var Recipe = /** @class */ (function (_super) {
    ...
    function Recipe(config) {
        ...
        _this.validateClaims = function (input) {
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [
                        2 /*return*/,
                        supertokens_website_1.default.validateClaims(input.claimValidators, input.userContext),
                    ];
                });
            });
        };
        _this.getInvalidClaimsFromResponse = function (input) {
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, supertokens_website_1.default.getInvalidClaimsFromResponse(input)];
                });
            });
        };
