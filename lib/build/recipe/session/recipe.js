...
var Recipe = /** @class */ (function (_super) {
    ...
    function Recipe(config) {
        ...
        _this.getAccessToken = function (input) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.getAccessTokenPayloadSecurely = function (input) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
        ...
        supertokens_website_1.default.init(__assign(__assign({}, config), { override: {
                functions: function (originalImpl, builder) {
                    var _a;
                    builder.override(function (oI) { return (__assign(__assign({}, oI), { getGlobalClaimValidators: function (input) {
                            var res = oI.getGlobalClaimValidators(input);
                            return __spreadArray(__spreadArray([], res.filter(function (x) { return priorityValidatorIds.includes(x.id); }), true), res.filter(function (x) { return !priorityValidatorIds.includes(x.id); }), true);
                        } })); });
            ...
            }, preAPIHook: function (context) { return __awaiter(_this, void 0, void 0, function () {
                var headers, response;
                return __generator(this, function (_a) {
                    headers = new Headers(context.requestInit.headers);
                    headers.set("rid", config.recipeId);
                    response = __assign(__assign({}, context), { requestInit: __assign(__assign({}, context.requestInit), { headers: headers }) });
            ...
            }); }, apiDomain: config.appInfo.apiDomain.getAsStringDangerous(), apiBasePath: config.appInfo.apiBasePath.getAsStringDangerous() }));
        return _this;
    }
    Recipe.init = function (config) {
        return function (appInfo, _clientType, enableDebugLogs, overrideMaps) {
            Recipe.instance = new Recipe(__assign(__assign({}, (0, utils_1.applyPlugins)(Recipe.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : [])), { appInfo: appInfo, recipeId: Recipe.RECIPE_ID, enableDebugLogs: enableDebugLogs }));
