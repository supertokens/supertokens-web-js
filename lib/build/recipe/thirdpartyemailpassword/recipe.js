        ...
        _this.emailPasswordRecipe = new recipe_1.default(
            {
                ...
                override: {
                    emailVerification: (_a = config.override) === null || _a === void 0 ? void 0 : _a.emailVerification,
                    functions: function () {
        ...
        _this.thirdPartyRecipe = new recipe_2.default(
            {
                ...
                postAPIHook: config.postAPIHook,
                override: {
                    emailVerification: (_b = config.override) === null || _b === void 0 ? void 0 : _b.emailVerification,
                    functions: function () {
