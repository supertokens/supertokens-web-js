...
var RecipeWrapper = /** @class */ (function () {
    ...
    RecipeWrapper.verifyEmail = function (input) {
        return recipe_1.default.getInstanceOrThrow().verifyEmail({
            token: input.token,
            options: input.options,
        });
    };
    RecipeWrapper.sendVerificationEmail = function (input) {
        return recipe_1.default.getInstanceOrThrow().sendVerificationEmail({ options: input.options });
    };
    RecipeWrapper.isEmailVerified = function (input) {
        return recipe_1.default.getInstanceOrThrow().isEmailVerified({ options: input.options });
    };
