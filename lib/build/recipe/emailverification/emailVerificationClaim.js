...
var EmailVerificationClaimClass = /** @class */ (function (_super) {
    ...
    function EmailVerificationClaimClass(getRecipeImpl) {
        var _this = _super.call(this, {
            ...
            refresh: function (userContext) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, getRecipeImpl().isEmailVerified({
        ...
        _this.validators = __assign(__assign({}, _this.validators), { isVerified: function (refetchTimeOnFalseInSeconds, maxAgeInSeconds) { return ({
                id: _this.id,
