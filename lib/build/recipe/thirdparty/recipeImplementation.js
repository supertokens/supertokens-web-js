...
function getRecipeImplementation(recipeId, appInfo) {
    ...
    return {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            urlWithState = alreadyContainsRedirectURI
                                ...
                                : (0, utils_1.appendQueryParamsToURL)(urlResponse.url, {
                                      state: state,
                                      redirect_uri: (0, utils_2.getThirdPartyProviderRedirectURL)({
        ...
        signInAndUp: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var stateFromStorage, code, stateFromQueryParams, redirectURI, _a, jsonBody, fetchResponse;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            redirectURI = (0, utils_2.getThirdPartyProviderRedirectURL)({
                                providerId: input.thirdPartyProviderId,
                                appInfo: input.config.appInfo,
                            });
                            return [
