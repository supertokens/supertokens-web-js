                    ...
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, querier.post({
                                ...
                                }, { body: { formFields: formFields, token: token, method: "token" } }, querier_1.default.preparePreAPIHook({
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [(_e.pathParams = (_f.tenantId = (_g.sent()) || "public",
                                    _f),
                                    _e), { body: { formFields: formFields, shouldTryLinkingWithSessionUser: shouldTryLinkingWithSessionUser } },
                                querier_1.default.preparePreAPIHook({
                                    recipePreAPIHook: recipeImplInput.preAPIHook,
