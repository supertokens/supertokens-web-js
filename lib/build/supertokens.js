...
var SuperTokens = /** @class */ (function () {
    function SuperTokens(config) {
        ...
        var _loop_1 = function (pluginIndex) {
            var pluginConfig = finalPluginList[pluginIndex].config;
            if (pluginConfig) {
                config = __assign(__assign({}, config), pluginConfig((0, utils_1.getPublicConfig)(config)));
            }
            ...
            if (pluginInit) {
                postSuperTokensInitCallbacks_1.PostSuperTokensInitCallbacks.addPostInitCallback(function () {
                    pluginInit(config, _this.pluginList, version_1.package_version);
