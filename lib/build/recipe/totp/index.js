...
exports.clearDeviceInfo =
    exports.setDeviceInfo =
...
var RecipeWrapper = /** @class */ (function () {
    ...
    RecipeWrapper.getDeviceInfo = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.getDeviceInfo(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    RecipeWrapper.setDeviceInfo = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.setDeviceInfo(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
    ...
    RecipeWrapper.clearDeviceInfo = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.clearDeviceInfo(
            __assign(__assign({}, input), {
                userContext: (0, utils_1.getNormalisedUserContext)(
                    input === null || input === void 0 ? void 0 : input.userContext
                ),
...
var getDeviceInfo = RecipeWrapper.getDeviceInfo;
exports.getDeviceInfo = getDeviceInfo;
var setDeviceInfo = RecipeWrapper.setDeviceInfo;
exports.setDeviceInfo = setDeviceInfo;
var clearDeviceInfo = RecipeWrapper.clearDeviceInfo;
exports.clearDeviceInfo = clearDeviceInfo;
