...
var RecipeWrapper = /** @class */ (function () {
    ...
    RecipeWrapper.getLoginChallengeInfo = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.getLoginChallengeInfo(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.getRedirectURLToContinueOAuthFlow = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.getRedirectURLToContinueOAuthFlow(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.logOut = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.logOut(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input.userContext) }));
    };
