...
function getRecipeImplementation(recipeImplInput) {
    ...
    return {
        ...
        getAuthorisationURLWithQueryParamsAndSetState: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var urlResponse, frontendRedirectURIToSave, stateToSendToAuthProvider, stateExpiry, _a, urlWithState;
                var _b, _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            _a = this.setStateAndOtherInfoToStorage;
                            _b = {};
                            _c = {
                                stateForAuthProvider: stateToSendToAuthProvider,
                                thirdPartyId: input.thirdPartyId,
                            };
                            return [4 /*yield*/, recipeImplInput.thirdParty.getTenantId()];
                        case 2: // 10 minutes expiry.
                            return [
                                4 /*yield*/,
                                _a.apply(this, [
                                    ((_b.state =
                                        ((_c.tenantId = _d.sent()),
                                        (_c.expiresAt = stateExpiry),
                                        (_c.redirectURIOnProviderDashboard =
                                            input.redirectURIOnProviderDashboard || input.frontendRedirectURI),
                                        (_c.pkceCodeVerifier = urlResponse.pkceCodeVerifier),
                                        _c)),
                                    (_b.userContext = input.userContext),
                                    _b),
                                ]),
                            ];
                        case 3:
                            _d.sent();
                            urlWithState = (0, utils_1.appendQueryParamsToURL)(urlResponse.url, {
        ...
        getAuthorisationURLFromBackend: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                var params, tenantId, _a, jsonBody, fetchResponse;
        ...
        getQueryParamsFromURL: function () {
            return (0, utils_1.getAllQueryParams)();
        },
    };
}
