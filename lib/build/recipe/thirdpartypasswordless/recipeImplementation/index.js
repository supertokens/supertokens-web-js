...
function getRecipeImplementation(recipeId, appInfo, preAPIHook, postAPIHook) {
    var thirdPartyImpl = (0, recipeImplementation_1.default)(recipeId, appInfo, preAPIHook, postAPIHook);
    var passwordlessImpl = (0, recipeImplementation_2.default)(recipeId, appInfo, preAPIHook, postAPIHook);
    return {
