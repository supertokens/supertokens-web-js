...
function getRecipeImplementation(recipeImplInput) {
    ...
    return {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/webauthn/options/register",
                                {
                                    body: JSON.stringify({
                                        email: email,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/webauthn/options/signin",
                                {
                                    body: JSON.stringify({}),
                                },
                                querier_1.default.preparePreAPIHook({
        ...
        signUp: function (_a) {
            var webauthnGeneratedOptionsId = _a.webauthnGeneratedOptionsId, credential = _a.credential, shouldTryLinkingWithSessionUser = _a.shouldTryLinkingWithSessionUser, options = _a.options, userContext = _a.userContext;
            return __awaiter(this, void 0, void 0, function () {
                var _b, jsonBody, fetchResponse, _c, _d;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/webauthn/signup",
                                {
                                    body: JSON.stringify({
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/webauthn/signin",
                                {
                                    body: JSON.stringify({
                                        webauthnGeneratedOptionsId: webauthnGeneratedOptionsId,
                                        credential: credential,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/webauthn/email/exists",
                                {},
                                { email: email },
                                querier_1.default.preparePreAPIHook({
                                    recipePreAPIHook: recipeImplInput.preAPIHook,
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/user/webauthn/reset/token",
                                {
                                    body: JSON.stringify({
                                        email: email,
                                    }),
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/user/webauthn/reset",
                                {
                                    body: JSON.stringify({
                                        token: token,
                                        webauthnGeneratedOptionsId: webauthnGeneratedOptionsId,
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.registerCredential({ registrationOptions: registrationOptions, userContext: userContext })];
                        case 2:
