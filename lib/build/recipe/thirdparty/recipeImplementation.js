...
function getRecipeImplementation(recipeId, appInfo) {
    ...
    return {
        getStateAndOtherInfoFromStorage: function () {
            try {
                var stateFromStorage = (0, utils_1.getSessionStorage)("supertokens-oauth-state-2");
        ...
        setStateAndOtherInfoToStorage: function (input) {
            var value = JSON.stringify(__assign({}, input.state));
            (0, utils_1.setSessionStorage)("supertokens-oauth-state-2", value);
        },
