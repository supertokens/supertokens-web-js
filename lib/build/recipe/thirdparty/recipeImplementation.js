    ...
    return {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.sessionStorage.setItem("supertokens-oauth-state-2", value)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        getAuthorisationURLWithQueryParamsAndSetState: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.getAuthorisationURLFromBackend({
                        ...
                        case 1:
                            urlResponse = _a.sent();
                            frontendRedirectURIToSave = input.redirectURIOnProviderDashboard !== undefined &&
                            ...
                            return [4 /*yield*/, this.setStateAndOtherInfoToStorage({
                                    state: {
        ...
        getAuthorisationURLFromBackend: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, querier.get({
                                path: "/<tenantId>/authorisationurl",
                                pathParams: {
                                    tenantId: input.tenantId || "public",
                                },
                                queryParams: __assign({ thirdPartyId: input.thirdPartyId, redirectURIOnProviderDashboard: input.redirectURIOnProviderDashboard }, (recipeImplInput.clientType !== undefined ? { clientType: recipeImplInput.clientType } : {})),
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.verifyAndGetStateOrThrowError({
                        ...
                        case 2:
                            ...
                            return [2 /*return*/, __assign(__assign({ status: "OK" }, (0, utils_1.normaliseUserResponse)("thirdparty", jsonBody)), { fetchResponse: fetchResponse })];
                    }
                });
            });
        },
        ...
        verifyAndGetStateOrThrowError: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (input.stateObjectFromStorage === undefined ||
