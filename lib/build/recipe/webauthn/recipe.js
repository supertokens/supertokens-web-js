...
var Recipe = /** @class */ (function (_super) {
    ...
    Recipe.init = function (config) {
        return function (appInfo, clientType, _enableDebugLogs, overrideMaps) {
            Recipe.instance = new Recipe(__assign(__assign({}, (0, utils_2.applyPlugins)(Recipe.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : [])), { recipeId: Recipe.RECIPE_ID, clientType: clientType, appInfo: appInfo }));
