...
var RecipeWrapper = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        tenantId = _c.sent();
                        return [4 /*yield*/, recipeImplementation.createCode(__assign(__assign({}, input), { shouldTryLinkingWithSessionUser: (_a = input.shouldTryLinkingWithSessionUser) !== null && _a !== void 0 ? _a : false, userContext: normalisedUserContext }))];
                    case 2:
                        createCodeResponse = _c.sent();
                        if (!(createCodeResponse.status === "OK")) return [3 /*break*/, 4];
                        return [4 /*yield*/, recipeImplementation.setLoginAttemptInfo({
                                attemptInfo: {
                                    tenantId: tenantId,
                                    deviceId: createCodeResponse.deviceId,
                                    preAuthSessionId: createCodeResponse.preAuthSessionId,
                                    shouldTryLinkingWithSessionUser: (_b = input.shouldTryLinkingWithSessionUser) !== null && _b !== void 0 ? _b : false,
                    ...
                    case 3:
                        _c.sent();
                        _c.label = 4;
                    case 4: return [2 /*return*/, createCodeResponse];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        recipe = recipe_2.default.getInstanceOrThrow();
                        recipeImplementation = recipe.recipeImplementation;
                        normalisedUserContext = (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext);
                    ...
                    case 1:
                         ...
                         */
                        return [2 /*return*/, recipeImplementation.resendCode(__assign(__assign({}, input), { tenantId: previousAttemptInfo === null || previousAttemptInfo === void 0 ? void 0 : previousAttemptInfo.tenantId, userContext: normalisedUserContext, deviceId: previousAttemptInfo === undefined ? "" : previousAttemptInfo.deviceId, preAuthSessionId: previousAttemptInfo === undefined ? "" : previousAttemptInfo.preAuthSessionId, shouldTryLinkingWithSessionUser: previousAttemptInfo === null || previousAttemptInfo === void 0 ? void 0 : previousAttemptInfo.shouldTryLinkingWithSessionUser }))];
                }
            });
        });
    };
    ...
    RecipeWrapper.consumeCode = function (input) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var recipe, recipeImplementation, userContext, additionalParams, attemptInfoFromStorage, shouldTryLinkingWithSessionUser, shouldTryLinkingWithSessionUser, linkCode, tenantId, preAuthSessionId;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        shouldTryLinkingWithSessionUser = (_a = attemptInfoFromStorage === null || attemptInfoFromStorage === void 0 ? void 0 : attemptInfoFromStorage.shouldTryLinkingWithSessionUser) !== null && _a !== void 0 ? _a : false;
                        additionalParams = {
                    ...
                    case 2:
                        ...
                        _b.label = 3;
                    case 3: return [2 /*return*/, recipeImplementation.consumeCode(__assign({ userContext: userContext, options: input === null || input === void 0 ? void 0 : input.options }, additionalParams))];
                }
            });
        });
    };
    ...
    RecipeWrapper.getLinkCodeFromURL = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.getLinkCodeFromURL(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.getPreAuthSessionIdFromURL = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.getPreAuthSessionIdFromURL(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.getTenantIdFromURL = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.getTenantIdFromURL(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.doesEmailExist = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.doesEmailExist(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.doesPhoneNumberExist = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.doesPhoneNumberExist(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.getLoginAttemptInfo = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.getLoginAttemptInfo(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        recipe = recipe_2.default.getInstanceOrThrow();
                        return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().recipeImplementation.getTenantId({ userContext: userContext })];
                    case 1:
                        tenantId = _a.sent();
                        return [2 /*return*/, recipe.recipeImplementation.setLoginAttemptInfo({
                                attemptInfo: __assign({ tenantId: tenantId, shouldTryLinkingWithSessionUser: input.attemptInfo.shouldTryLinkingWithSessionUser }, input.attemptInfo),
                                userContext: userContext,
                            })];
                }
            });
    ...
    RecipeWrapper.clearLoginAttemptInfo = function (input) {
        return recipe_2.default.getInstanceOrThrow().recipeImplementation.clearLoginAttemptInfo(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
