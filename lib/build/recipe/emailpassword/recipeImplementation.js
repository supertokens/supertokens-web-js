                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, querier.post(tenantId, "/user/password/reset", { body: JSON.stringify({ formFields: formFields, token: token, method: "token" }) }, querier_1.default.preparePreAPIHook({
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/user/password/reset/token",
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            _d = (_c = querier).post;
                            return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().recipeImplementation.getTenantId({ userContext: userContext })];
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/signup",
                                { body: JSON.stringify({ formFields: formFields, shouldTryLinkingWithSessionUser: shouldTryLinkingWithSessionUser }) },
                                querier_1.default.preparePreAPIHook({
                                    recipePreAPIHook: recipeImplInput.preAPIHook,
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            _d = (_c = querier).post;
                            return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().recipeImplementation.getTenantId({ userContext: userContext })];
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/signin",
                                { body: JSON.stringify({ formFields: formFields, shouldTryLinkingWithSessionUser: shouldTryLinkingWithSessionUser }) },
                                querier_1.default.preparePreAPIHook({
                                    recipePreAPIHook: recipeImplInput.preAPIHook,
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            _d = (_c = querier).get;
                            return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().recipeImplementation.getTenantId({ userContext: userContext })];
                        case 1: return [4 /*yield*/, _d.apply(_c, [_e.sent(), "/emailpassword/email/exists",
                                {},
                                { email: email },
                                querier_1.default.preparePreAPIHook({
                                    recipePreAPIHook: recipeImplInput.preAPIHook,
