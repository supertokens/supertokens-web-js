...
var Recipe = /** @class */ (function (_super) {
    ...
    function Recipe(config) {
        ...
        postSuperTokensInitCallbacks_1.PostSuperTokensInitCallbacks.addPostInitCallback(function () {
            sessionClaimValidatorStore_1.SessionClaimValidatorStore.addClaimValidatorFromOtherRecipe(Recipe.MultiFactorAuthClaim.validators.hasCompletedMFARequirementsForAuth());
        });
        return _this;
    }
    Recipe.init = function (config) {
        return function (appInfo, clientType, _enableDebugLogs, overrideMaps) {
            Recipe.instance = new Recipe(__assign(__assign({}, (0, utils_2.applyPlugins)(Recipe.RECIPE_ID, config, overrideMaps !== null && overrideMaps !== void 0 ? overrideMaps : [])), { recipeId: Recipe.RECIPE_ID, appInfo: appInfo, clientType: clientType }));
    ...
    Recipe.MultiFactorAuthClaim = new multiFactorAuthClaim_1.MultiFactorAuthClaimClass(function () { return Recipe.getInstanceOrThrow().recipeImplementation; });
    return Recipe;
