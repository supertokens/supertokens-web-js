...
function getRecipeImplementation(recipeImplInput) {
    ...
    var storageHandlers = (0, utils_2.normaliseStorageHandlerInput)(recipeImplInput.storageHandlerInput);
    return {
        getStateAndOtherInfoFromStorage: function () {
            return __awaiter(this, void 0, void 0, function () {
                var stateFromStorage, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, storageHandlers.sessionStorage.getItem("supertokens-oauth-state-2")];
                        case 1:
                            stateFromStorage = _b.sent();
                            if (stateFromStorage === null) {
                                return [2 /*return*/, undefined];
                            }
                            return [2 /*return*/, JSON.parse(stateFromStorage)];
                        case 2:
                            _a = _b.sent();
                            return [2 /*return*/, undefined];
                        case 3:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [
                                4 /*yield*/,
                                storageHandlers.sessionStorage.setItem("supertokens-oauth-state-2", value),
                            ];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            return [
                                4 /*yield*/,
                                this.getStateAndOtherInfoFromStorage({
                                    userContext: input.userContext,
                                }),
                            ];
                        case 1:
