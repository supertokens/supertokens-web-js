...
var Querier = /** @class */ (function () {
    function Querier(recipeId, appInfo) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.fetch(this.getFullUrl(template), __assign(__assign({ method: "POST" }, config), { body: this.safelyStringifyBody(config.body) }), preAPIHook, postAPIHook)];
                    case 1:
                        result = _b.sent();
                        return [4 /*yield*/, this.getResponseJsonOrThrowGeneralError(result)];
                    case 2:
        ...
        this.getFullUrl = function (path) {
            ...
            return "".concat(_this.appInfo.apiDomain.getAsStringDangerous()).concat(basePath).concat(normalisedPath.getAsStringDangerous());
        };
