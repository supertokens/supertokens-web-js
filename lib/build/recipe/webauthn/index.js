...
exports.registerCredentialWithRecoverAccount = exports.createAndRegisterCredentialForSessionUser = exports.registerCredential = exports.removeCredential = exports.listCredentials = exports.doesBrowserSupportWebAuthn = exports.authenticateCredential = exports.createCredential = exports.authenticateCredentialWithSignIn = exports.registerCredentialWithSignUp = exports.recoverAccount = exports.generateRecoverAccountToken = exports.getEmailExists = exports.signIn = exports.signUp = exports.getSignInOptions = exports.getRegisterOptions = exports.init = void 0;
...
var RecipeWrapper = /** @class */ (function () {
    ...
    RecipeWrapper.getRegisterOptions = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.getRegisterOptions(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.getSignInOptions = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.getSignInOptions(__assign(__assign({}, input), { userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext) }));
    };
    /**
    ...
    RecipeWrapper.signUp = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.signUp(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.signIn = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.signIn(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.getEmailExists = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.getEmailExists(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.generateRecoverAccountToken = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.generateRecoverAccountToken(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.recoverAccount = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.recoverAccount(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.registerCredentialWithSignUp = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.registerCredentialWithSignUp(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.authenticateCredentialWithSignIn = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.authenticateCredentialWithSignIn(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.registerCredentialWithRecoverAccount = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.registerCredentialWithRecoverAccount(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
     ...
     * @returns `{ status: "OK", ...}` if successful
     */
    RecipeWrapper.createAndRegisterCredentialForSessionUser = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.createAndRegisterCredentialForSessionUser(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.listCredentials = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.listCredentials(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
    ...
    RecipeWrapper.removeCredential = function (input) {
        return recipe_1.default.getInstanceOrThrow().recipeImplementation.removeCredential(__assign(__assign({}, input), { userContext: input === null || input === void 0 ? void 0 : input.userContext }));
    };
    /**
     * Register the new device with the passed user details
     *
...
var createAndRegisterCredentialForSessionUser = RecipeWrapper.createAndRegisterCredentialForSessionUser;
