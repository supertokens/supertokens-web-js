...
var Recipe = /** @class */ (function () {
    ...
    Recipe.prototype.verifyEmail = function (_a) {
        var token = _a.token,
            options = _a.options;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [
                    2 /*return*/,
                    this.recipeImplementation.verifyEmail({
                        token: token,
                        config: this.config,
                        options: options,
                    }),
    ...
    Recipe.prototype.sendVerificationEmail = function (_a) {
        var options = _a.options;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [
                    2 /*return*/,
                    this.recipeImplementation.sendVerificationEmail({
                        config: this.config,
                        options: options,
                    }),
                ];
    ...
    Recipe.prototype.isEmailVerified = function (_a) {
        var options = _a.options;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [
                    2 /*return*/,
                    this.recipeImplementation.isEmailVerified({
                        config: this.config,
                        options: options,
                    }),
                ];
